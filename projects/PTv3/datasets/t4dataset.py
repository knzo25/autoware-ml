...
class T4Dataset(DefaultDataset):
    ...
    def get_info_path(self, split):
        ...
        if split == "train":
            return os.path.join(self.data_root, "info/kenzo124", f"t4dataset_xx1_infos_train.pkl")
        elif split == "val":
            return os.path.join(self.data_root, "info/kenzo124", f"t4dataset_xx1_infos_val.pkl")
        elif split == "test":
