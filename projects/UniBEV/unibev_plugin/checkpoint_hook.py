...
class CheckpointLateStageHook(CheckpointHook):
    ...
    def __init__(
        self, interval=1, by_epoch=True, start=0.5, save_optimizer=True, out_dir=None, file_client_args=None, **kwargs
    ):
        super().__init__()
    ...
    def before_run(self, runner):
        ...
        runner.logger.info(
            f"The Late Stage Checkpoints will be saved from the epoch {self.start_epoch} "
