...
class DETRHeadOld(AnchorFreeHead):
    ...
    def __init__(
        ...
        **kwargs,
        ...
        if class_weight is not None and (self.__class__ is DETRHeadOld):
    ...
    def _load_from_state_dict(
        ...
        if (version is None or version < 2) and self.__class__ is DETRHeadOld:
            convert_dict = {
